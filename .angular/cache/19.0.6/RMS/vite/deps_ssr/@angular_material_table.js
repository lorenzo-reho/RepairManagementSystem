...
var BreakpointObserver = class _BreakpointObserver {
  ...
  _destroySubject = new import_rxjs6.Subject();
  constructor() {
  }
...
var Typeahead = class {
  _letterKeyStream = new import_rxjs7.Subject();
  _items = [];
  _selectedItemIndex = -1;
  /** Buffer for the letters that the user has pressed */
  _pressedLetters = [];
  _skipPredicateFn;
  _selectedItem = new import_rxjs7.Subject();
...
var DateAdapter = class {
  ...
  locale;
  _localeChanges = new import_rxjs8.Subject();
...
var MatOption = class _MatOption {
  ...
  _stateChanges = new import_rxjs8.Subject();
  constructor() {
...
var MatTableDataSource = class extends DataSource {
  ...
  _renderData = new import_rxjs9.BehaviorSubject([]);
  /** Stream that emits when a new filter string is set on the data source. */
  _filter = new import_rxjs9.BehaviorSubject("");
  /** Used to react to internal changes of the paginator that are made by the data source itself. */
  _internalPageChanges = new import_rxjs9.Subject();
  /**
  ...
  constructor(initialData = []) {
    super();
    this._data = new import_rxjs9.BehaviorSubject(initialData);
    this._updateChangeSubscription();
  }
  /**
  ...
  _updateChangeSubscription() {
    const sortChange = this._sort ? (0, import_rxjs9.merge)(this._sort.sortChange, this._sort.initialized) : (0, import_rxjs9.of)(null);
    const pageChange = this._paginator ? (0, import_rxjs9.merge)(this._paginator.page, this._internalPageChanges, this._paginator.initialized) : (0, import_rxjs9.of)(null);
    const dataStream = this._data;
    const filteredData = (0, import_rxjs9.combineLatest)([dataStream, this._filter]).pipe((0, import_operators7.map)(([data]) => this._filterData(data)));
    const orderedData = (0, import_rxjs9.combineLatest)([filteredData, sortChange]).pipe((0, import_operators7.map)(([data]) => this._orderData(data)));
    const paginatedData = (0, import_rxjs9.combineLatest)([orderedData, pageChange]).pipe((0, import_operators7.map)(([data]) => this._pageData(data)));
